...
public class Cajero extends Usuario {
    ...
    public Cajero(int dni, String usuario, String nombre, String apellido, String correo, String password, Usuario.Roles rol, String turno, int cajaAsignada, float ventasDiarias) {
